 ...
 * ─────────────────────────────────────────────────────────────────────────────
 * Construye y gestiona el botón flotante de WhatsApp.
 * El mensaje y el número salen de SITE_CONFIG.
 * ─────────────────────────────────────────────────────────────────────────────
 */
...
const WhatsApp = (() => {
  ...
  function init() {
    ...
    // Construir el HTML
    container.innerHTML = `
      <span class="whatsapp-tooltip" aria-hidden="true">
    ...
    // Mostrar el botón con pequeño delay para no competir con LCP
    setTimeout(() => {
